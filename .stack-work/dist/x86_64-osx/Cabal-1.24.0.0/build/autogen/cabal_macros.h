...
/* package titanic-0.1.0.0 */
#define VERSION_titanic "0.1.0.0"
#define MIN_VERSION_titanic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package cassava-0.4.5.0 */
#define VERSION_cassava "0.4.5.0"
...
#define CURRENT_COMPONENT_ID "titanic-0.1.0.0"

#define CURRENT_PACKAGE_KEY "titanic-0.1.0.0"
